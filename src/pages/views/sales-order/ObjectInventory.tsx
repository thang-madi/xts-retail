...
export const OrderInventoryView: React.FC<any> = (props) => {
    ...
    const { dataRow, choiceItemValue } = props
    // console.log('OrderProductRowCard.dataRow', dataRow)

    const handleClickProduct = () => {
        const itemValue = createXTSObject('XTSItemValue', { dataType: dataRow.product.dataType, id: dataRow.product.id })
    ...
    return (
        <Card className='views-sales-order-inventory-view-card' onClick={handleClickProduct}>
            <div style={{ display: 'flex', width: '100%', alignItems: 'center' }}>
                ...
                <div className='views-sales-order-inventory-view-card-picture' >
                    <Image
                        className='views-sales-order-inventory-view-card-picture-image'
                        width='100%'
                        height='auto'
...
export const OrderInventoryEdit: React.FC<XTSObjectRowProps> = (props) => {
    ...
    return (
        <div className='views-sales-order-inventory-edit' >
            <Card className='views-sales-order-inventory-edit-card'>
                <div style={{ margin: 10, width: 22, }}>
                    #{dataRow._lineNumber}
                </div>

                <div className='views-sales-order-inventory-edit-card-picture'>
                    <Image
                        className='views-sales-order-inventory-edit-card-picture-image'
                        width='100%'
                        height='auto'
                        src={fileStorageURL + dataRow._picture?.presentation}
                        fallback=''
                ...
                <div className='views-sales-order-inventory-edit-card-info'>
                    <div className='sales-invoice-inventory-edit-card-info-description'>
                        {dataRow.product?.presentation}
                    </div>

                    <div className='views-sales-order-inventory-edit-quantity'>

                        <div>
                            <div className='views-sales-order-inventory-edit-quantity-title-short'>SL: </div>
                            <div className='views-sales-order-inventory-edit-quantity-title-long'>Số lượng: </div>
                        </div>

                        <div className='views-sales-order-inventory-edit-quantity-group'>
                            ...
                            <FormSelect
                                ...
                                itemProps={{
                                    // label: 'Đơn vị tính',
                                    required: false,
                                    className: 'views-sales-order-inventory-edit-uom'
