...
import { apiRequest, actions } from '../../data-storage/slice-payment-receipt'
...
const ObjectViewPage: React.FC<XTSObjectViewProps> = (props) => {
    ...
    return (
        ...
        <div className='payment-receipt-view'>
            ...
            <Card className='payment-receipt-view-header'>

                <div className='payment-receipt-view-title'>
                    {objectPresentation(dataObject.objectId, dataObject.operationKind)}
                </div>

                <Divider className='payment-receipt-view-divider' orientation='center' />

                <div className='payment-receipt-view-item'>
                    <div className='payment-receipt-view-item-title'
                    >Cơ sở: </div>
                ...
                <div className='payment-receipt-view-item'>
                    <div className='payment-receipt-view-item-title'>Ghi chú: </div>
