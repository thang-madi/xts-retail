...
import '../../components/ListSettings/index.css'
...
// OK
const UOMClassifierListSettings: React.FC<any> = (props) => {
            ...
            <Form form={form} >
                ...
                >
                    <div className='list-settings-sort-item'>
                        <div className='list-settings-sort-item-label'>Theo tên gọi</div>
                        <Button
                            className={'list-settings-sort-item-direction'}
                            icon={sortData.description && <SortDescendingOutlined /> || <SortAscendingOutlined />}
                            onClick={() => sortItemOnClick('description')}
                        />
                    </div>
                </Card>
            </Form>
...
export { UOMClassifierListSettings }
