    ...
    return (
        ...
        <div className='view-page'>
            ...
            <Card style={{ margin: 5 }}>
                ...
                <Divider className='view-page-divider' orientation='center' />

                <div className='view-page-item'>
                    <div className='view-page-item-title'
                    >Khách hàng: </div>
