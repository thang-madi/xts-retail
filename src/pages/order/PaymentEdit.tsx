...
// function PaymentEditPage(props) {                                                           // Payment
const PaymentEditPage: React.FC<XTSObjectEditProps> = (props) => {         // Customer
    ...
    const pageTitle = 'Thanh toán: ' + String(dataObject.objectId?.presentation).replace('của khách', 'số')
