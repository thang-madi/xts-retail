...
import { OrderProductRowView, OrderProductRowEditPage, OrderProductRowEdit } from './OrderProductRow'      // order-product-row
...
//
const OrderEditPage: React.FC<XTSObjectEditProps> = (props) => {         // Order
        ...
        <div className='edit-page'>
            ...
            >
                ...
                <Card style={{ margin: 5 }}>
                    ...
                    <Divider className='edit-page-divider' orientation='center' />

                    <FormInput
                        itemName='customer'
                        dataType='XTSCounterparty'
                        itemProps={{
                            // className: 'edit-page-item-customer',
                            className: 'edit-page-item-label',
                            label: 'Khách hàng',
                            labelCol: { span: 4 },
                            wrapperCol: { span: 20 },
                        }}
                    ...
                    <div className={(company) && 'edit-page-item-visible' || 'edit-page-item-hidden'}>
                        <FormSelect
                            itemName='orderState'
                            ...
                            selectProps={{
                                className: 'edit-page-item-order-state-value',
                                required: false,
                    ...
                    <div className={(user) && 'edit-page-item-visible' || 'edit-page-item-hidden'}>
                        <FormInput
