...
const ObjectViewPage: React.FC<XTSObjectViewProps> = (props) => {
    ...
    return (
        ...
        <div className='price-registration-view'>

            <Loader isLoading={status === REQUEST_STATUSES.LOADING} />

            <Card className='price-registration-view-header'>

                <div className='price-registration-view-title'>
                    {objectPresentation(dataObject.objectId)}
                </div>

                <Divider className='price-registration-view-divider' orientation='center' />

                <div className='price-registration-view-item'>
                    <div className='price-registration-view-item-title'
                    >Cơ sở: </div>
                ...
                <div className='price-registration-view-item'>
                    <div className='price-registration-view-item-title'>Ghi chú: </div>
