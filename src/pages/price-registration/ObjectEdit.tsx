...
import { AppstoreAddOutlined, CheckCircleOutlined, CheckOutlined, CloseCircleOutlined, DownOutlined, FileTextOutlined, InsertRowBelowOutlined, SaveOutlined } from '@ant-design/icons'
...
const ObjectEditPage: React.FC<XTSObjectEditProps> = (props) => {
    ...
    return (
        <div className='price-registration-edit'>
            ...
            >
                ...
                <Card className='price-registration-edit-header'>

                    <div className='price-registration-edit-title'>
                        {objectPresentation(dataObject.objectId)}
                    </div>

                    <Divider className='price-registration-edit-divider' orientation='center' />

                    {/* <div className='price-registration-edit-posted'>
                    ...
                    {/* <FormInput
                        ...
                        itemProps={{
                            className: 'price-registration-edit-item-label',
                    ...
                    {/* <div className='price-registration-edit-currency'>
                        <FormInput
                    ...
                    {/* <div className={(company) && 'price-registration-edit-item-visible' || 'price-registration-edit-item-hidden'}>
                        <FormSelect
                            itemName='orderState'
                            ...
                            selectProps={{
                                className: 'price-registration-edit-item-order-state-value',
                                required: false,
                    ...
                    {/* <div className={(user) && 'price-registration-edit-item-visible' || 'price-registration-edit-item-hidden'}>
                        <FormInput
                    ...
                    <FormInput
                        ...
                        {...commonItemProps}
                    />
                    <div className='price-registration-edit-item'>
                        <div className='price-registration-edit-item-label'>Cơ sở: </div>
                        <div>{objectPresentation(dataObject.documentBasis)}</div>
                    </div>

                    <Button icon={<DownOutlined />}>{'Điền phần bảng'}</Button>
                ...
                <BottomBar
                    ...
                    action1={{ onClick: addProduct, title: 'Thêm hàng', icon: <AppstoreAddOutlined className='context-menu-button-icon' /> }}
