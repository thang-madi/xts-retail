...
export const ObjectInventoryView: React.FC<any> = (props) => {
    ...
    return (
        <Card className='price-registration-inventory-view-card' >

            <div style={{ margin: 10, width: 22, }}>
                #{dataRow._lineNumber}
            </div>

            {/* <div className='price-registration-inventory-view-card-picture' >
                <Image
                    className='price-registration-inventory-view-card-picture-image'
                    width='100%'
                    height='auto'
            ...
            <div className='price-registration-inventory-view-card-info' >
                <div className='price-registration-inventory-view-card-info-description'>{dataRow.product?.presentation}</div>
                <div>{`Đơn giá: ${dataRow.price} ${dataRow.currency.presentation}/${dataRow.uom.presentation}`}</div>
                {/* <div>Đơn giá: {dataRow.price} {dataRow.currency.presentation}/chiếc</div> */}
                {/* <div>Số lượng: {dataRow.quantity} {dataRow.uom?.presentation}</div> */}
                {/* <div className='price-registration-inventory-view-amount' >
                    <div>Thành tiền: </div>
...
export const ObjectInventoryEdit: React.FC<XTSObjectRowProps> = (props) => {
    ...
    const changeRowData = (newData: NewData): void => {
        ...
        const { price = dataRow.price, characteristic = dataRow.characteristic, uom } = newData
    ...
    return (
        <div className='price-registration-inventory-edit'>
            <Card className='price-registration-inventory-edit-card'>
                <div style={{ margin: 10, width: 22, }}>
                    #{dataRow._lineNumber}
                </div>

                {/* <div className='price-registration-inventory-edit-card-picture'>
                    <Image
                        className='price-registration-inventory-edit-card-picture-image'
                        width='100%'
                        height='auto'
                        src={fileStorageURL + dataRow._picture?.presentation}
                        fallback=''
                ...
                <div className='price-registration-inventory-edit-card-info'>
                    <div className='product-row-edit-card-info-description'>
                        {dataRow.product?.presentation}
                    </div>

                    <div className='price-registration-inventory-edit-quantity'>

                        {/* <div>
                            <div className='price-registration-inventory-edit-quantity-title-short'>SL: </div>
                            <div className='price-registration-inventory-edit-quantity-title-long'>Số lượng: </div>
                        </div> */}

                        {/* <div className='price-registration-inventory-edit-quantity-group'>
                            ...
                            <FormSelect
                                ...
                                itemProps={{
                                    // label: 'Đơn vị tính',
                                    required: false,
                                    className: 'price-registration-inventory-edit-uom'
                                }}
                                selectProps={{
                    ...
                    <div className='price-registration-inventory-edit-price'>

                        <div>{`Đơn giá (${dataRow.currency.presentation}/${dataRow.uom.presentation}):`}</div>
                        <AmountInput
                            dataObject={dataRow}
                            itemName='price'
                            min={0}
                    ...
                    {/* <div className='price-registration-inventory-edit-amount'>
                        <div>Thành tiền: </div>
                        <b>{dataRow.amount?.toLocaleString('vi-VN')} {currencyPresentation}</b>
                    </div> */}
                </div>
