...
export const apiRequest = createAsyncThunk(
    'salesInvoices/apiRequest',
    (data: any, thunkAPI: any) => postRequestWithThunk(data, thunkAPI, sliceSalesInvoice.actions)
)

const sliceSalesInvoice = createSlice({
    name: 'salesInvoices',
    initialState,
    reducers,
...
export default sliceSalesInvoice.reducer
export const actions = sliceSalesInvoice.actions
